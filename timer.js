...
function get_time_string(){
    ...
    var localHours = elapsed.getHours() - 1;
...
function update(){
	...
	innerHTML += "<th class='mdl-data-table__cell--non-numeric'>" + past_times[i] + "</th><th class='mdl-data-table__cell--non-numeric'>Level " + (i + 1) + "</th></tr>"
